...
def main():
    ...
    parser.add_argument(
        ...
        default="developer",
        help="Documentation mode: 'developer' for technical docs with code, 'user' for high-level business-focused docs (default: developer)",
    )
    ...
    parser.add_argument(
        "--no-jekyll",
        action="store_true",
        help="Disable Jekyll front matter generation (default: enabled)",
    )
    parser.add_argument(
        "--jekyll-nav-order",
        type=int,
    ...
    print(f"Documentation mode: {args.doc_mode.capitalize()}")
    print(f"LLM caching: {'Disabled' if args.no_cache else 'Enabled'}")
    print(
        f"Jekyll front matter: {'Disabled' if args.no_jekyll else 'Enabled (nav_order=' + str(args.jekyll_nav_order) + ')'}"
    )
